...
class TestMecab(unittest.TestCase):
    ...
    def testParse(self):
        ...
        expected = \
            [AT(text='프리', dictionary_form='프리', pos='NNG'),
             ...
             AT(text='살', dictionary_form='살', pos='VV'),
             create_ending_token('고', None),
             AT(text='있', dictionary_form='있', pos='VX'),
             create_ending_token('는', None),
             AT(text='더', dictionary_form='더', pos='MAG'),
             AT(text='즐', dictionary_form='즐', pos='XPN'),
             AT(text='리', dictionary_form='리', pos='NNG'),
             AT(text='부부', dictionary_form='부부', pos='NNG'),
